...
export default function CustomerForm(props) {
  ...
  //   let zip = await getAddress(address.place_id);
  //   console.log(zip);
  //   let street = `${address.terms[0].value} ${address.terms[1].value}`;
  //   let city = address.terms[2].value;
  //   let state = address.terms[3].value;
  ...
  const selectAddress = (place) => {
    ...
    let street = `${place.terms[0].value} ${place.terms[1].value}`;
    let city = place.terms[2].value;
    let state = place.terms[3].value;
